    ...
    <div class="hero min-h-screen">
        <div class="hero-content lg:flex-row flex-col">
            <img alt="Mizu's screenshot"
                 class="max-w-lg lg:max-w-3xl rounded-lg shadow-2xl"
            ...
            <h1 class="lg:ml-10 text-base-100 text-3xl font-bold lg:text-left text-center"
                ...
                It is time to <span class="text-info">socialize</span>,
                <span class="text-error">customize</span> Minecraft clients as
                <span class="uppercase text-accent">you</span> wish.
            </h1>
        </div>
    </div>
</Wave>
...
<div class="hero min-h-screen">
    <div class="hero-content lg:flex-row flex-col">
        <div class="flex flex-col">
            <h1 class="mr-10 text-accent text-3xl font-bold  lg:text-right text-center"
                transition:fly={{ y: 50, duration: 500, delay: 300 }}>
                Play with your friends
            </h1>
            <p class="mt-10 lg:mr-10 text-xl lg:text-right text-center">
